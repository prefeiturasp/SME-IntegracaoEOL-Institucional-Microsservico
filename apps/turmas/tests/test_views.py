...
class TestT01SincronizacoesTurma:
    ...
    def test_retorna_501(self, api_client, db):
        """Retorna 501 para endpoint cross-domain T01."""
        resp = api_client.get(
            "/api/v1/institucional/ues/019251/turmas/ABC123"
            "/sincronizacoes-institucionais/"
        )
        assert resp.status_code == 501

    def test_shape_cross_domain(self, api_client, db):
        """Payload contém dominio, transitionGateway e detail."""
        resp = api_client.get(
            "/api/v1/institucional/ues/019251/turmas/ABC123"
            "/sincronizacoes-institucionais/"
        )
    ...
    def test_rota_alternativa_retorna_501(self, api_client, db):
        ...
        resp = api_client.get(
            "/api/v1/institucional/turmas/019251/turmas/ABC123"
            "/sincronizacoes-institucionais/"
        )
        assert resp.status_code == 501
        assert resp.data["dominio"] == "pedagogico"
...
class TestT02AnosLetivosSincronizacao:
    ...
    def test_retorna_501(self, api_client, db):
        """Retorna 501 para endpoint cross-domain T02."""
        resp = api_client.get(
    ...
    def test_rota_alternativa_retorna_501(self, api_client, db):
        ...
        resp = api_client.get(
            "/api/v1/institucional/ues/ue/019251"
            "/sincronizacoes-institucionais/anos-letivos/"
        )
        assert resp.status_code == 501
        assert resp.data["dominio"] == "pedagogico"
...
class TestRotasCanonicase:
    ...
    def test_t01_alternativo_retorna_501(self, api_client, db):
        """Alias alternativo de T01 retorna 501."""
        resp = api_client.get(
            "/api/v1/institucional/turmas/019251/turmas/ABC123"
            "/sincronizacoes-institucionais/"
        )
    ...
    def test_t02_alternativo_retorna_501(self, api_client, db):
        """Alias alternativo de T02 retorna 501."""
        resp = api_client.get(
            "/api/v1/institucional/ues/ue/019251"
            "/sincronizacoes-institucionais/anos-letivos/"
        )
