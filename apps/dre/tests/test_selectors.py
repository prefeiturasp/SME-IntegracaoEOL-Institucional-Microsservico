...
class TestListarCodigosDresAbrangencia:
    """Cobre a listagem de códigos das DREs."""

    def test_retorna_lista_vazia_sem_dres_elegiveis(self, db):
        """Sem DREs elegíveis retorna lista vazia."""
        from apps.dre.selectors import listar_codigos_dres_abrangencia

        assert listar_codigos_dres_abrangencia() == []

    def test_retorna_apenas_codigos_na_ordem_da_origem(
...
class TestListarNomesAbreviacoesDres:
    """Cobre a listagem de nomes e abreviações das DREs."""

    def test_retorna_lista_vazia_sem_dres_elegiveis(self, db):
        """Sem DREs elegíveis retorna lista vazia."""
        from apps.dre.selectors import listar_nomes_abreviacoes_dres

        assert listar_nomes_abreviacoes_dres() == []

    def test_retorna_contrato_legado_na_ordem_da_origem(
        self, dre_abrangencia_factory
    ):
        """Retorna código, nome e abreviação na ordem materializada."""
        from apps.dre.selectors import listar_nomes_abreviacoes_dres
